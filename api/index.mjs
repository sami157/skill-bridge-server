...
var getAllCategories2, createCategory2;
...
var createSubject, getAllSubjects, getSubjectsByCategory, subjectService;
var init_subject_service = __esm({
  "src/modules/subjects/subject.service.ts"() {
    "use strict";
    init_prisma();
...
var createSubject2, getAllSubjects2, getSubjectsByCategory2;
var init_subject_controller = __esm({
  "src/modules/subjects/subject.controller.ts"() {
    "use strict";
    init_subject_service();
    createSubject2 = async (req, res) => {
      try {
    ...
    getSubjectsByCategory2 = async (req, res) => {
      try {
...
var router2, subjectRouter;
var init_subjects_route = __esm({
  "src/modules/subjects/subjects.route.ts"() {
    "use strict";
    init_subject_controller();
    init_verifyAuth();
    ...
    subjectRouter = router2;
  }
});

// src/modules/tutors/tutors.service.ts
var createTutorProfile, updateTutorProfile, getAllTutorProfiles, getTutorProfileById, tutorProfileService;
var init_tutors_service = __esm({
  "src/modules/tutors/tutors.service.ts"() {
    "use strict";
    init_prisma();
    ...
    getAllTutorProfiles = async (filters) => {
...
var createTutorProfile2, updateTutorProfile2, getAllTutorProfiles2, getTutorProfileById2;
var init_tutors_controller = __esm({
  "src/modules/tutors/tutors.controller.ts"() {
    "use strict";
    init_tutors_service();
    createTutorProfile2 = async (req, res) => {
      try {
    ...
    updateTutorProfile2 = async (req, res) => {
      try {
    ...
    getAllTutorProfiles2 = async (req, res) => {
      try {
    ...
    getTutorProfileById2 = async (req, res) => {
      try {
...
var router3, tutorRouter;
var init_tutors_route = __esm({
  "src/modules/tutors/tutors.route.ts"() {
    "use strict";
    init_tutors_controller();
    init_verifyAuth();
...
import "http";
var createBooking, cancelBooking, completeBooking, getBookings, getBookingById, createReview, bookingsService;
var init_bookings_service = __esm({
  "src/modules/bookings/bookings.service.ts"() {
    "use strict";
    init_enums();
    init_prisma();
    ...
    completeBooking = async (bookingId, tutorId) => {
      const booking = await prisma.booking.findUnique({
        where: { id: bookingId }
      });
      if (!booking) {
    ...
    getBookings = async ({ userId, role, status }) => {
    ...
    createReview = async ({ bookingId, studentId, rating, comment }) => {
      const booking = await prisma.booking.findUnique({
        where: { id: bookingId },
...
var createBooking2, cancelBooking2, completeBooking2, getBookings2, getBookingById2, createReview2, bookingsController;
var init_bookings_controller = __esm({
  "src/modules/bookings/bookings.controller.ts"() {
    "use strict";
    init_bookings_service();
    init_enums();
    createBooking2 = async (req, res, next) => {
      try {
    ...
    cancelBooking2 = async (req, res, next) => {
      try {
    ...
    completeBooking2 = async (req, res, next) => {
      try {
        const { bookingId } = req.params;
    ...
    getBookings2 = async (req, res, next) => {
      try {
    ...
    getBookingById2 = async (req, res, next) => {
      try {
        const { bookingId } = req.params;
        const userId = req.user?.id;
        const role = req.user?.role;
    ...
    createReview2 = async (req, res, next) => {
      try {
        const studentId = req.user?.id;
...
var router4, bookingRouter;
var init_bookings_route = __esm({
  "src/modules/bookings/bookings.route.ts"() {
    "use strict";
    init_bookings_controller();
    init_verifyAuth();
    router4 = Router();
    router4.post(
      "/",
